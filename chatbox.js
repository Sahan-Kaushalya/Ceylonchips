...
const API_KEY = "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";
...
const generateResponse = (chatElement) => {
    ...
    fetch(API_URL, requestOptions).then(res => res.json()).then(data => {
        ...
        messageElement.textContent = "Please wait for one of our sales representatives to contact you...";
